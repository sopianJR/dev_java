...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // kesimpulanny adalah perkalian atau pembagian akan dilakukan terlebih dahulu
        ...
        // penghitungan persamaan kuadrat
        System.out.println("PENGHITUNGAN PERSAMAAN KUADRAT");
        int m,x,c;
